...
const Precon = () => {
    ...
    <div className=" my-2 text-left bg-back-server bg-cover bg-center lg:mr-10 text-white py-10 px-10  max-h-full overflow-auto">
      ...
      <p className="text-3xl ">
        I act as an in-house full-stack developer, innovating and improving all
        the systems within the business. This means managing a database for
        business information and developing software to analyse and present the
        information. In addition, I create scripts to process and deliver
